...
![Version](https://img.shields.io/badge/version-0.2.0--beta.4-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Platform](https://img.shields.io/badge/platform-Linux%20%7C%20macOS%20%7C%20Windows-lightgrey)

> **Status: Beta (`v0.2.0-beta.4`)** — the MVP is complete and functional. Installers are published on [GitHub Releases](https://github.com/asaje379/openk8s-desktop/releases).
